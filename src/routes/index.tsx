        ...
        {techDrawerOpen && (
          ...
          >
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between bg-panel px-[4.5vw] py-5">
              ...
              <nav className="hidden items-center gap-6 xl:flex">
              {[["Solutions", "dr-solutions"], ["Dual Fuel Kit", "dr-kit"], ["Technology", "dr-tech"], ["Benefits", "dr-benefits"], ["Comparison", "dr-compare"], ["Components", "dr-components"], ["Installations", "dr-installs"], ["Case Studies", "dr-cases"], ["Economics", "dr-econ"]].map(([label, id]) => (
