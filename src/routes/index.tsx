        ...
        {techDrawerOpen && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <section className="relative overflow-hidden border-b border-border"><img src={economicsImage} alt="Operating economics case study" loading="lazy" className="absolute inset-0 h-full w-full object-cover opacity-15" /><div className="absolute inset-0 bg-panel/95" /><div className="relative mx-auto max-w-[1440px] px-5 py-20 text-background lg:px-10 lg:py-28"><div className="flex flex-wrap items-end justify-between gap-5"><div><SectionLabel index="OM / 13" dark>Operating economics</SectionLabel><h2 className="mt-5 text-4xl font-extrabold tracking-tight lg:text-6xl">Savings, on the meter.</h2></div><span className="glass-panel rounded-[7px] px-4 py-3 font-mono text-[10px] uppercase tracking-[0.13em] text-background/75">Specific case · 500 kVA at 75% load</span></div><div className="mt-12 grid gap-3 sm:grid-cols-2 lg:grid-cols-4"><div className="glass-panel rounded-[10px] p-6"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/55">Saving due to DFK</p><p className="mt-3 font-mono text-4xl text-signal">â‚¹561<span className="text-base text-background/55"> / hour</span></p></div><div className="glass-panel rounded-[10px] p-6"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/55">Estimated monthly saving</p><p className="mt-3 font-mono text-4xl">â‚¹22,424</p></div><div className="glass-panel rounded-[10px] p-6"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/55">Estimated annual saving</p><p className="mt-3 font-mono text-4xl">â‚¹2,69,082</p></div><div className="glass-panel rounded-[10px] p-6"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/55">Fuel cost reduction</p><p className="mt-3 font-mono text-4xl text-signal">7.6%</p></div></div><div className="mt-3 grid gap-px overflow-hidden rounded-[10px] border border-background/15 bg-background/15 sm:grid-cols-2 lg:grid-cols-4"><div className="bg-panel-soft p-5"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/50">Genset rating</p><p className="mt-2 font-mono text-xl">500 kVA</p></div><div className="bg-panel-soft p-5"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/50">Load</p><p className="mt-2 font-mono text-xl">75%</p></div><div className="bg-panel-soft p-5"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/50">Hours / month</p><p className="mt-2 font-mono text-xl">40 hours</p></div><div className="bg-panel-soft p-5"><p className="font-mono text-[10px] uppercase tracking-[0.13em] text-background/50">Fuel prices</p><p className="mt-2 font-mono text-sm leading-relaxed">Diesel â‚¹94/L · LPG â‚¹190/kg · PNG â‚¹85/SmÂ³</p></div></div></div></section>
